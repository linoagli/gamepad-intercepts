...
namespace DS4Library
{
    internal static class NativeMethods
    {
        ...
        public static extern bool SetupDiGetDeviceProperty(IntPtr deviceInfo, ref SP_DEVINFO_DATA deviceInfoData, ref DEVPROPKEY propkey, ref UInt64 propertyDataType, byte[] propertyBuffer, int propertyBufferSize, ref int requiredSize, uint flags);
        ...
        [DllImport("hid.dll", SetLastError = true)]
        static internal extern bool HidD_GetSerialNumberString(IntPtr HidDeviceObject, byte[] Buffer, Int32 BufferLength);
    }
}
